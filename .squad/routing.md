...
|-----------|----------|----------|
| Technical leadership | Holden | Code review, cross-cutting decisions, triage, quality gates |
| Architecture & design | Naomi | System design, API contracts, data models, design patterns |
| Implementation & coding | Amos | Feature dev, bug fixes, refactoring, scaffolding |
| Documentation | Prax | README, API docs, guides, tutorials, changelogs |
| Dependencies & packages | Alex | Dependency audits, version conflicts, lock files, supply chain |
| npm & packaging | Elvi | package.json, publishing, bundling, workspaces, npm scripts |
| PRDs & requirements | Miller | PRDs, FRDs, specs, acceptance criteria, feasibility |
| Issue tracking | Bull | GitHub Issues, labels, backlog grooming, templates, boards |
